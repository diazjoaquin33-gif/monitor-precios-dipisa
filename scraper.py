...
def _consultar_lider_api(url: str):
    """3 Capas de ataque para Líder (GraphQL, Orquestador Móvil, y Proxy Edge)"""
    ...
    # Capa 1: API Mobile de Walmart (SVCS)
...
def _consultar_curl_cffi(url: str, cfg: dict):
    """Extracción para Tottus, Jumbo, y Unimarc evadiendo Cloudflare"""
    for intento in range(3): # Intenta 3 veces cambiando la firma del navegador
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                # Estrategia Genérica por Regex (Jumbo, Unimarc)
    ...
    return None, None, False, "Error al extraer HTML"

def _consultar_api_sisa(url: str, cfg: dict):
    """Consulta directa a la API de Santa Isabel"""
    ...
    return None, None, False, "Error API Sisa"
...
if __name__ == "__main__":
    ...
    resultados_actuales = {}
    # Bajamos los workers a 3 para no saturar las APIs y evitar que nos bloqueen por spam
